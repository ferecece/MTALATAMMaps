...
addEventHandler("onResourceStart", resourceRoot, function()		
	...
	-- Table management
	dbExec(DATABASE, "CREATE TABLE IF NOT EXISTS BadlandsTable(playername TEXT, vehiclename TEXT, score INTEGER)")
	sortQuery = dbQuery(DATABASE, "SELECT * FROM BadlandsTable WHERE vehiclename = ? ORDER BY score", getVehicleNameFromModel(currentVehicleModel))		
