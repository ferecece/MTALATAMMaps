...
addEventHandler("onResourceStart", resourceRoot, function()		
	...
	-- Table management
	dbExec(DATABASE, "CREATE TABLE IF NOT EXISTS CoinTossTable(playername TEXT, vehiclename TEXT, score INTEGER)")
	sortQuery = dbQuery(DATABASE, "SELECT * FROM CoinTossTable WHERE vehiclename = ? ORDER BY score", getVehicleNameFromModel(currentVehicleModel))		
