...
local availablevehicles = {
    -- 4-door sedans
    --admiral,glendaledamaged,elegant,emperor,glendale,greenwood,
    intruder,merit,--nebula,oceanic,premier,primo,sentinel,stafford,sunrise,tahoma,vincent,washington,willard,
    --policels,policesf,policelv,
    -- coupes,
    --alpha,blistacompact,bravura,buccaneer,cadrona,
    club,--esperanto,euros,feltzer,fortune,
    hermes,--hustler,majestic,manana,picador,previon,virgo,
    -- muscle 
    buffalo,--clover,phoenix,
    sabre,--stallion,tampa,
    --hotknife,
    -- suvs
    ...
    -- stationwagons
    --perennial,regina,
    romero,--solair,stratum,flash,
    -- lowrider
    --blade,broadway,
    remington,--savanna,
    slamvan,--tornado,voodoo,
    -- sports/racer
    banshee,--bullet,
    cheetah,--comet,elegy,
    infernus,--jester,sultan,supergt,turismo,uranus,windsor,zr350,
    --hotringracer,hotringracer2,hotringracer3,
    -- motorcycles
    --bf400,fcr900,freeway,nrg500,pcj600,sanchez,
    wayfarer,--hpv1000,
    --pizzaboy,
    faggio,
    -- bicycles
  ...
  coach,
    ...
    -- pickups
    --towtruck,utilityvan,bobcat,sadler,sadlerdamaged,walton,
    yosemite,
    -- small vans
    hotdog,mrwhoopee,--berkleysrcvan,
    burrito,--moonbeam,newsvan,pony,rumpo,
    -- large vans
