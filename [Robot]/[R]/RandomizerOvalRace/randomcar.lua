---------------------------------------------------------------------
-- This script is server side, with some basic skeleton code.
---------------------------------------------------------------------
...
---------------------------------------------------------------------
--This function is used to execute code at certain events of the race
---------------------------------------------------------------------
function changeState(newstate,oldstate)
	...
	if (newstate == "Running" and oldstate == "GridCountdown") then
		--Put code here that executes on race start
	end
