...
local availablevehicles = {
  -- 4-door sedans
  -- glendaledamaged
  admiral,elegant,emperor,glendale,greenwood,intruder,merit,nebula,oceanic,premier,primo,sentinel,stafford,sunrise,tahoma,vincent,washington,willard,policels,policesf,policelv,

  -- coupes,
  alpha,blistacompact,club,euros,feltzer,hustler,bravura,buccaneer,cadrona,esperanto,fortune,hermes,majestic,manana,picador,previon,virgo,

  -- muscle 
  buffalo,phoenix,hotknife,tampa,clover,sabre,stallion,

  -- suvs
  -- rancherlure
  huntley,landstalker,rancher,mesa,sandking,patriot,fbirancher,fbitruck,policeranger,

  -- stationwagons
  perennial,regina,romero,solair,stratum,flash,

  -- lowrider
  blade,broadway,savanna,tornado,remington,slamvan,voodoo,

  -- sports/racer
  banshee,bullet,cheetah,comet,elegy,infernus,jester,sultan,supergt,turismo,uranus,windsor,zr350,
  hotringracer,hotringracer2,hotringracer3,bloodringbanger,

  -- motorcycles
  bf400,fcr900,freeway,nrg500,pcj600,sanchez,wayfarer,hpv1000,pizzaboy,faggio,
  ...
  -- pickups
  -- sadlerdamaged
  towtruck,utilityvan,bobcat,sadler,walton,yosemite,

  -- small vans
  hotdog,camper,mrwhoopee,berkleysrcvan,burrito,moonbeam,newsvan,pony,rumpo,

  -- large vans
  securicar,benson,boxville,boxvillemission,mule,yankee,journey,ambulance,
