...
--    rhino,
	...
	--3th line: Bikes (all)
	--4th line: Civil Servant / Public Transportation (no Baggage 485)
	--5th line: Government Vehicles (no Rhino 432)
	--6th line: Heavy and Utility Trucks (no Dozer 486, Dumper 406, Linerunner (From "Tanker Commando") 514)
	--7th line: Light Trucks and Vans (no Forklift 530, Tug 583)
	--8th line: Lowriders (all)
	--9th line: Muscle Cars (all)
	--10th line: Recreational (all)
	...
	--local carids = 	{602, 496, 401, 518, 527, 589, 419, 533, 526, 474, 545, 517, 410, 600, 436, 580, 439, 549, 491,
			...
			--552, 431, 438, 437, 574, 420, 525, 408,
			--416, 433, 427, 490, 528, 407, 544, 523, 470, 598, 596, 597, 599, 601, 428,
			--499, 609, 498, 524, 532, 578, 573, 455, 588, 403, 423, 414, 443, 515, 531, 456,
			--459, 422, 482, 605, 418, 572, 582, 413, 440, 543, 478, 554,
			--536, 575, 534, 567, 535, 576, 412,
			--402, 542, 603, 475,
			--568, 424, 504, 457, 483, 508, 571, 500, 444, 556, 557, 471, 495, 539,
			--429, 541, 415, 480, 562, 565, 434, 494, 502, 503, 411, 559, 561, 560, 506, 451, 558, 555, 477,
			--579, 400, 404, 489, 479, 442, 458}

	--boatids: (no Marquis 484, Predator 430, Reefer 453)
	local boatids = {472, 473, 493, 595, 452, 446, 454}

	--planeids: (no Andromeda 592, AT-400 577, Cargobob 548, Hunter 425, Leviathan 417, Maverick 487, Nevada 553, News Chopper 488, Police Maverick 497, Raindance 563, Seasparrow 447, Sparrow 467, Cropduster 512)
	local planeids = {511, 593, 476, 519, 460, 513}
...
function randomCar(checkpoint, time)
	if not source then
	  ...
	  local oldHeight = heights[vehmodel]
        if (checkpoint >= 1 and checkpoint <= 6) or (checkpoint >= 10 and checkpoint <= 15) or checkpoint == 19 or checkpoint == 20 or checkpoint == 21 or checkpoint == 22 then
				zmodifier(veh,1)
