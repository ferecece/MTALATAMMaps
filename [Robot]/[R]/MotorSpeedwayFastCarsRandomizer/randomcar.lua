...
local availablevehicles = {
    ...
    -- sports/racer
    banshee,bullet,cheetah,--comet,elegy,
    infernus,--jester,sultan,supergt,
...
--    rhino,
    ...
    function randomCar(checkpoint, time)
		if not source then
		  ...
		  if (checkpoint == 3 or checkpoint == 10 or checkpoint == 17 or checkpoint == 24) then
