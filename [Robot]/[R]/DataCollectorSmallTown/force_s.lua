...
addEventHandler("onResourceStart", resourceRoot, function()		
	...
	-- Table management
	dbExec(DATABASE, "CREATE TABLE IF NOT EXISTS FuckedupTownTable(playername TEXT, vehiclename TEXT, score INTEGER)")
	sortQuery = dbQuery(DATABASE, "SELECT * FROM FuckedupTownTable WHERE vehiclename = ? ORDER BY score", getVehicleNameFromModel(currentVehicleModel))		
