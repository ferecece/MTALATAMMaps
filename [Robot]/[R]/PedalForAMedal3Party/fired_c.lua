...
addEventHandler("onClientRender", getRootElement(), function()
	if fired then
		dxDrawBorderedText(1, "you're late!", 0, 0, screenX, screenY*0.75, tocolor (0, 204, 0, 255), 3, "pricedown", "center", "center", true, false)
		dxDrawBorderedText(1, "OG Loc is off the mic. Let the party get started.", 0, 0, screenX, screenY*0.98, tocolor (0, 204, 0, 255), 1, "bankgothic", "center", "bottom", true, false)
	end 

	if hired then
		dxDrawBorderedText(1, "mission passed?", 0, 0, screenX, screenY*0.75, tocolor (200, 0, 0, 255), 3, "pricedown", "center", "center", true, false)
		dxDrawBorderedText(1, "Just in time for OG Loc's performance.", 0, 0, screenX, screenY*0.98, tocolor (200, 0, 0, 255), 1, "bankgothic", "center", "bottom", true, false)
	end 
