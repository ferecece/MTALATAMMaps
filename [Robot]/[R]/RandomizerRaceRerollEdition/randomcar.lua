...
--    farmtrailer,trailer,trailertankercommando,trailerstairs,trailer1,trailer2,trailer3,
    -- airplanes
      -- andromada,at400,beagle,cropduster,
      dodo,hydra,
      --nevada,
      rustler,
      --shamal,skimmer,
...
--    rcbaron,
    -- helicopters
  --  cargobob,hunter,leviathan,
    maverick,newschopper,
  --policemaverick,raindance,seasparrow,sparrow,
  --  rcgoblin,rcraider,
    -- boats
...
function clientClick( player )
	if client then
    	givePlayerRandomVehicle(player)
    end    
end
addEvent("playerClientClick", true)
addEventHandler("playerClientClick", resourceRoot, clientClick)
