...
addEventHandler("onClientRender", getRootElement(), function()
	if fired then
		dxDrawBorderedText(1, "busted", 0, 0, screenX, screenY*0.75, tocolor (40, 190, 255, 255), 3, "pricedown", "center", "center", true, false)
		dxDrawBorderedText(1, "You took too long.", 0, 0, screenX, screenY*0.98, tocolor (200, 0, 0, 255), 1, "bankgothic", "center", "bottom", true, false)
	end

	if hired then
		dxDrawBorderedText(1, "you've escaped!", 0, 0, screenX, screenY*0.75, tocolor (150, 123, 35, 255), 3, "pricedown", "center", "center", true, false)
		dxDrawBorderedText(1, "Hop in, Alex. Let's get out of here.", 0, 0, screenX, screenY*0.98, tocolor (245, 245, 245, 255), 1, "bankgothic", "center", "bottom", true, false)
	end
end )
