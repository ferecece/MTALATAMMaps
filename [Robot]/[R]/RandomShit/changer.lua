...
function randomCar(checkpoint)
    ...
    addEventHandler('myEvent', getRootElement(), randomCar)

----------------------- Has vehicle hit checkpoint?

function chkcheck(checkpoint, time)
	triggerClientEvent ( source, "onHitCheckpoint", source, "Hello World!", checkpoint )
end
addEvent('onPlayerReachCheckpoint')
addEventHandler('onPlayerReachCheckpoint', getRootElement(), chkcheck)

----------------------- Create secret marker
...
----------------------- Has player hit secret marker

function switchBMX(player, dimension)
...
addEventHandler('onMarkerHit', getRootElement(), switchBMX)
