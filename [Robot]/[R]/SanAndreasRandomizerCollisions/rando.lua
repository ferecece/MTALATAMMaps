...
local availablevehicles = {
  ...
  -- coupes,
  alpha,blistacompact,club,euros,feltzer,hustler,
  --bravura,buccaneer,cadrona,esperanto,fortune,hermes,majestic,manana,picador,previon,virgo,

  -- muscle 
  buffalo,phoenix,hotknife,tampa,
  --clover,sabre,stallion,
  ...
  -- stationwagons
  --perennial,regina,romero,solair,
  stratum,flash,

  -- lowrider
  --blade,broadway,savanna,tornado,
  remington,slamvan,voodoo,
