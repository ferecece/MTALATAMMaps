...
-- note that non-standard vehicles like aircraft/boats/trailers aren't thoroughly tested and will likely require height value adjustments
local heights = {
  [landstalker] = 2.22,
  [bravura] = 1.55,
  [buffalo] = 1.55,
...
local availablevehicles = {
  -- 4-door sedans
  --admiral,glendaledamaged,elegant,emperor,glendale,greenwood,intruder,merit,nebula,oceanic,premier,primo,sentinel,stafford,sunrise,
  tahoma,
  --vincent,washington,willard,
  --policels,policesf,policelv,

  -- coupes,
  --alpha,blistacompact,bravura,buccaneer,cadrona,club,esperanto,euros,feltzer,fortune,hermes,hustler,
  --majestic,
  --manana,picador,previon,virgo,
