...
function shootPrimary()
	...
	if hasWeapon then
		...
		elseif currentWeapon == 4 then -- Chainsaw		
			...
			displayMessage = true
			currentMessage = "Hit people to make them explode while you're flashing!"
			setTimer(function()
				starPower = false
...
addEventHandler("onClientColShapeHit", getRootElement(), function(theElement, matchingDimension) 
	...
	if x == 3397 or x == 3781 or x == 3453 then
...
addEventHandler ( "onClientResourceStart", resourceRoot,  function()
	createColCircle(3397, -925.92578125, 20)
	createColCircle(3781, -1107.8603515625, 20)
	createColCircle(3453, -1307.7626953125, 20)
