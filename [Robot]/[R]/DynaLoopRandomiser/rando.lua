...
local availablevehicles = {
  dune,dumper,mesa,sandking,monster,monster2,monster3,bobcat,bandito,bfinjection,quadbike,sanchez,patriot,landstalker,rancher,barracks,journey,sadler,
  -- 4-door sedans
...
--  policels,policesf,policelv,
  ...
  -- coupes,
--  alpha,blistacompact,bravura,cadrona,club,euros,feltzer,fortune,hermes,hustler,majestic,manana,previon,virgo,
--  esperanto,buccaneer
--  picador,
...
--  perennial,regina,romero,solair,stratum,flash,
  ...
  -- lowrider
--  blade,broadway,remington,savanna,tornado,voodoo,
--  slamvan,
...
--  monster2,monster3,
  ...
  -- pickups
--  bobcat,sadler,sadlerdamaged,walton,yosemite,
--  towtruck,utilityvan,
