...
function createJump0(player)
	...
	local x = 2475.8000488281
	local y = -4353
	local z = 1.2000000476837
	local markerType = "corona"
	local markerSize = 4
	local r,g,b,a = getColorFromString("#DDC92199")
	local velX = 0
	local velY = -1
	local velZ = 0.64999998
...
function createJump1(player)
	...
	local x = 2475.6999511719
	local y = -4481.1000976562
	local z = 0.89999997615814
	local markerType = "corona"
	local markerSize = 4
	local r,g,b,a = getColorFromString("#DDC92199")
	local velX = 0
