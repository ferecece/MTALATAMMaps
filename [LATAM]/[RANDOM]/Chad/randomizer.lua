-- Vehiculos deshabilitados. En general aviones, botes y vehiculos misc.
disallowedVehicle = {
...
function randomCar(checkpoint, time) 
	...
	triggerClientEvent("onRandomizerCheckpoint", root, veh, vehicleID)
end 

addEvent('onPlayerReachCheckpoint') 
addEventHandler('onPlayerReachCheckpoint', getRootElement(), randomCar) 

function changeVehicleModel(vehicle, id)
	setElementModel(vehicle, id)
end

addEvent("onChangeVehicle", true)
addEventHandler("onChangeVehicle", root, changeVehicleModel)